      ...
      >
        {mode === 'ai' && (
          <div className="flex gap-4 items-center">
            <h4 className="text-default-700 font-medium">
            ...
            <Button
              ...
              onClick={() => {
                setAiExample(
                  aiExamples[
                    aiExamples.findIndex(
                      (el) => el.description === aiExample.description
                    ) + 1
                  ] || aiExamples[0]
                )
              }}
            >
              <PiShuffleBold fontSize="1.1rem" />
              Load another
            </Button>
          </div>
        )}
