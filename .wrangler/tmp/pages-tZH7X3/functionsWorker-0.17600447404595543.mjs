  ...
  "../node_modules/replicate/lib/util.js"(exports, module) {
    ...
    async function createHMACSHA256(secret, data) {
      ...
      if (typeof crypto === "undefined" && typeof __require === "function") {
        crypto = __require("node:crypto").webcrypto;
      }
...
// ../.wrangler/tmp/bundle-gNedsU/middleware-loader.entry.ts
init_functionsRoutes_0_7916785008288825();
init_checked_fetch();
init_modules_watch_stub();

// ../.wrangler/tmp/bundle-gNedsU/middleware-insertion-facade.js
init_functionsRoutes_0_7916785008288825();
init_checked_fetch();
init_modules_watch_stub();
...
//# sourceMappingURL=functionsWorker-0.17600447404595543.mjs.map
